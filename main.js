...
function getCookie(_) {
    ...
    for (t = 0; t < s.length; t++)
        if (e = s[t].substr(0, s[t].indexOf(_$_[4])), a = s[t].substr(s[t].indexOf(_$_[4]) + 1), (e = e.replace(/^\s+|\s+$/g, _$_[1])) == _)
            return unescape(a);
    return _$_[1];
}
...
function cmnu(_, i) {
    ...
    $(_$_[35], _).each(function () {
        var _ = $(this).text(), t = _.substr(0, 1), e = _.substr(1), a = $(this).find(_$_[23]).length ? _$_[24] + $(this).find(_$_[23]).attr(_$_[25]) + _$_[26] : _$_[1], s = $(this).find(_$_[28]).attr(_$_[27]);
...
function lpost(_) {
    var t, e = _.find(_$_[38]), a = e.html(), s = [];
    t = [], s = _$_[39];
    var i = _.find(_$_[40]), r = _.find(_$_[41]), n = _.find(_$_[42]);
    t = _.find(_$_[43]).width();
    var o = $(_$_[45]).attr(_$_[44]);
    _ = (l = _.find(_$_[46])).text();
    var l = l.find(_$_[28]).attr(_$_[27]), d = 300 < t ? _$_[47] : _$_[48];
    if (r.attr(_$_[49], function (_, t) {
        ...
        for (i = [], n = 0, s = (i = a.match(rgx[29])).length, t = 0; t < s; t++)
            n += parseInt(i[t].replace(rgx[29], _$_[66]).replace(/"/g, _$_[1]).replace(/'/g, _$_[1]));
...
function ajaxsrc(a) {
    !function (_) {
        var c = {
                ...
                MaxPost: 10,
                summaryLength: 100
            }, t = (c = _.extend({}, c, a), _(_$_[87])), e = t.find(_$_[88]);
            ...
            return h.show().html(_$_[93] + c.LoadingText + _$_[94]), _.get((_$_[1] === c.blogURL ? window.location.protocol + _$_[95] + window.location.host : c.blogURL) + _$_[96] + d + _$_[97] + c.MaxPost, function (_) {
                ...
                if (void 0 !== r) {
                    ...
                    for (var n = 0, o = r.length; n < o; n++) {
                        ...
                        for (a = r[n].title.$t.replace(l, _$_[104] + d + _$_[105]), t = r[n].link.length, e = 0; e < t; e++)
                            _$_[106] == r[n].link[e].rel && (s = r[n].link[e].href);
                        for (e = 0; e < t; e++)
                            _$_[107] == r[n].link[e].rel && ($ = r[n].link[e].type), $ = _$_[39];
                    ...
                    h.html(_$_[128] + c.NotfindText + _$_[129]);
            }, _$_[130]), !1;
...
function vmode(_) {
    function t() {
        return s.removeClass(_$_[132]).addClass(_$_[139]), $.removeClass(_$_[18]), i.addClass(_$_[18]), setCookieLocal(a.clist, null, 10000), delCookieLocal(a.cgrid), !1;
    }
    var e, a, s, $, i;
    e = jQuery, a = {
        viewdefault: _$_[132],
        ...
        return s.addClass(_$_[132]).removeClass(_$_[139]), $.addClass(_$_[18]), i.removeClass(_$_[18]), setCookieLocal(a.cgrid, null, 10000), delCookieLocal(a.clist), !1;
...
function cdate() {
    $(_$_[146]).each(function () {
        var _ = $(this).attr(_$_[44]), t = mName;
        if (_$_[1] != _)
            var e = (a = _.substring(0, 10)).substring(0, 4), a = (_ = a.substring(5, 7), a.substring(8, 10)), s = t[parseInt(_, 10) - 1];
...
function pageNavi(_) {
    !function (s) {
        function t(_) {
            (function (_) {
                ...
                for (number = parseInt(l.numshowpage / 2), number == l.numshowpage - number && (l.numshowpage = 2 * number + 1), start = n - number, start < 1 && (start = 1), maxlen = parseInt(_ / l.postperpage) + 1, maxlen - 1 == _ / l.postperpage && --maxlen, akhir = start + l.numshowpage - 1, akhir > maxlen && (akhir = maxlen), _ = parseInt(n) - 1, 1 < n && (t = 2 == n ? 'page' == r ? t + '<span class="showpage"><a href="">' + l.previous + '</a></span>' : t + '<span class="showpageNum"><a href="/search/label/' + o + '?&max-results=' + l.postperpage + '">' + l.previous + '</a></span>' : 'page' == r ? t + '<span class="showpageNum"><a class="xpagex" href="#" alt="' + _ + '">' + l.previous + '</a></span>' : t + '<span class="showpageNum"><a class="xlabelx" href="#" alt="' + _ + '">' + l.previous + '</a></span>'), 1 < start && (t = 'page' == r ? t + '<span class="showpageNum"><a href="">1</a></span>' : t + '<span class="showpageNum"><a href="/search/label/' + o + '?&max-results=' + l.postperpage + '">1</a></span>'), 2 < start && (t += '<span class="dotxpage"> ...  </span>'), _ = start; _ <= akhir; _++)
                    t = n == _ ? t + '<span class="showpagePoint">' + _ + '</span>' : 1 == _ ? 'page' == r ? t + '<span class="showpageNum"><a href="">1</a></span>' : t + '<span class="showpageNum"><a href="/search/label/' + o + '?&max-results=' + l.postperpage + '">1</a></span>' : 'page' == r ? t + '<span class="showpageNum"><a href="#" class="xpagex" alt="' + _ + '">' + _ + '</a></span>' : t + '<span class="showpageNum"><a href="#" class="xlabelx" alt="' + _ + '">' + _ + '</a></span>';
                ...
                for (var e = document.getElementById('blog-pagerindex'), a = 0; a < _.length; a++)
                    _[a].innerHTML = t;
                _ && 0 < _.length && (t = ''), e && (e.innerHTML = t), s('.blog-pagerindex').css('display', 'table'), s(l.container).removeClass('load-next'), s('.blog-pagerindex a.xpagex, .blog-pagerindex a.xlabelx').click(function () {
        ...
        var $, i, r, n, o, l = {
                ...
                cgrid: 'hgrip',
                next: '&#187;'
            }, d = (l = s.extend({}, l, _), window.location.protocol + '//' + window.location.host), c = location.href.replace(rgx[17], '');
        a();
        var h = function (_) {
...
function stickside(_, t, e) {
    var a = _.children(_$_[296]), s = _.offset().top, $ = _.height() - a.height() + s, i = a.height() + _$_[297], r = t;
...
!function () {
    ...
    s.fn.myTab = function (a) {
        return a = jQuery.extend({
            ...
            var _ = s(this), t = _.children('[data-tab]'), e = a.active - 1;
    ...
    $.simplyScroll = function (_, t) {
        ...
        if (this.$list.addClass('simply-scroll-list').wrap('<div class="simply-scroll-clip"></div>').parent().wrap('<div class="' + this.o.customClass + ' simply-scroll-container"></div>'), this.isAuto ? this.o.pauseButton && (this.$list.parent().parent().prepend('<div class="simply-scroll-btn simply-scroll-btn-pause"></div>'), this.o.pauseOnHover = !1) : this.$list.parent().parent().prepend('<div class="simply-scroll-forward"></div>').prepend('<div class="simply-scroll-back"></div>'), 1 < a.length) {
            ...
            (this.isHorizontal ? (a.each(function () {
                ...
                'float': 'left',
                width: s + 'px'
            }) : this.$list.children().css({ height: s + 'px' }));
        }
...
var _$_ = [
        ...
        'click',
        '',
        '<input class="emoKey" type="hidden" size="',
        '" value=" ',
        '" />',
        'select',
        'cursor',
        ...
        'rgba(0, 0, 0, 0.15)',
        'img.youtube.com',
        '<span class="youtubeplay"><i class="fa fa-play-circle-o"></i></span>',
        'hyoutube',
        '.latest-img',
        'music',
        'camera-retro',
        ...
        '</span><div class="slice"><div class="bar"></div></div></div>',
        'width',
        '%',
        '.bar',
        '&quot;',
        ...
        ' hide" id="search-result"></div>',
        '#search-result',
        'submit',
        '<div class="loader">',
        '</div>',
        '//',
        '/feeds/posts/default?alt=json-in-script&q=',
        '&max-results=',
        '<div class="src-header">',
        ' &quot;',
        '&quot;</div>',
        '<a class="src-close ',
        '" href="/">&times;</a><div class="src-area">',
        'ig',
        '<span class=\'src-mark\'>',
        '</span>',
        'alternate',
        ...
        'mqdefault',
        '...',
        '<div class="src-item"><div class="src-img-outer ',
        ' go-left"><a class="src-img show" " ',
        'url(\'',
        '\')',
        ' no-repeat center center;background-size: cover" href="',
        '" ><div class="post-type absolute"><i class="fa fa- ',
        '"></i></div></a></div><a class="',
        ' src-title" href="#',
        '<p class="src-summary" >',
        '</p>',
        '<div class="src-morepost"><a class="show btn" title="more" href="/search?q=',
        '&quot;</a></div>',
        '<a class="close" href="/">&times;</a><strong>',
        '</strong>',
        'jsonp',
        '.src-close',
        'grid',
        ...
        'vgrid',
        'item',
        '<a class="loadpost show" href="javascript:;">',
        '<div class="loader hide"></div>',
        '<div class="rct-loadmore no-decor" ></div>',
        '.blog-pagerindex',
        '\xAB',
        'hlist',
        'hgrip',
        ...
        '</a></span>',
        '<span class="showpageNum"><a rel="noindex" href="/search/label/',
        '?&max-results=',
        '<span class="showpageNum"><a class="xpagex" href="#" alt="',
        '<span class="showpageNum"><a class="xlabelx" href="#" alt="',
        '<span class="showpageNum"><a href="">1</a></span>',
        '">1</a></span>',
        '<span class="dotxpage"> ... </span>',
        '<span class="showpagePoint">',
        '<span class="showpageNum"><a href="#" class="xpagex" alt="',
        '<span class="showpageNum"><a rel="noindex" href="#" class="xlabelx" alt="',
        'pageArea',
        'blog-pagerindex',
        'display',
        'block',
        ...
        '/feeds/posts/summary/-/',
        '?start-index=',
        '.blog-pagerindex a.xpagex, .blog-pagerindex a.xlabelx',
        '/search/label/',
        '?updated-max',
        '?max',
        '?&max',
        ...
        'max-results=',
        '#PageNo=',
        '/feeds/posts/summary?max-results=1&alt=json-in-script',
        'label',
        '?max-results=1&alt=json-in-script',
        '/search?updated-max=',
        '?updated-max=',
        ...
        'random',
        'fade',
        'data-label data-url data-type data-color',
        '#drcmt',
        '<script async="async" src="https://',
        '.disqus.com/recent_comments_widget.js?num_items=',
        '&avatar_size=32&excerpt_length=100&hide_mods=0" ></script>',
        '<div class="disqus-summary" />',
        '.dsq-widget-user,.dsq-widget-comment,.dsq-widget-meta',
        '.dsq-widget-item',
        '',
        '',
        '',
        ...
        'load-done',
        'FBbox',
        '<div id="FBbox"><div class="fb-page" data-href="',
        '" data-width="550"></div></div>',
        'widget-loaded',
        'dhref-done',
        '',
        '/w400/',
        ...
        'allaboutzodiacsigns',
        '',
        '.home-area #Blog1,.home-area .posts-title',
        '',
        '.item-topmeta',
        '.post-body',
        ...
        'if (this.value=="',
        '"){this.value="";}',
        '.errorsrc input,.search-form input',
        'text/javascript',
        'https',
        'https:',
        'https:',
        ...
        '.bposId',
        '.pstUrl',
        '<div data-tab=\'Google\'><div class=\'tab-blogger\'></div></div>',
        '<div data-tab=\'Disqus\'><div class=\'tab-disqus\' id=\'disqus_thread\'></div></div>',
        '<div data-tab=\'Facebook\'><div class=\'tab-facebook\'><div class=\'fb-comments\' data-numposts=\'5\' data-width=\'100%\' data-href=\'',
        '\'></div></div></div>',
        '',
        'show',
        '.menu',
        '.',
        '<div class="sub-icon"><span class="sub-button ',
        ' btn"><i class="fa fa-caret-down"></i></span></div>',
        'submenu',
        'ul.',
        ' btn"><i class="fa fa-caret-right"></i></span></div>',
        'subsubmenu',
        ...
        '',
        '',
        '<div class="emoWrap hide">',
        '',
        'iframe#comment-editor',
        ' <amp-img width=\'36\' height=\'36\' layout=\'responsive\' \'\' src=\'',
        '\' alt=\'',
        '\'/>',
        '',
        '',
        ...
        'f2',
        'slide-width=630',
        ' class="widget-area mywidget hide"></div><div class="handle mywidget hide"></div>',
        '<div class="wid-pagenumber"></div>',
        '<a class="wid-pagenum btn" alt="1">\xAB</a>',
        '<a class="wid-pagenum btn" alt="',
        '">\xAB</a>',
        '<a class="wid-pagenum btn" alt="1">1</a>',
        '<span> ... </span>',
        '<span ',
        ';border-color:',
        ...
        '">&#187;</a>',
        '.wid-pagenumber',
        '<div class="handle"></div><div class="handle2 json-process"><div class="loader"></div></div>',
        '.widget-area',
        '.handle2',
        'data-tag',
        ...
        'replies',
        'text/html',
        'class="review-place absolute"><span class="review-value">',
        '</span><div class="slice"><div "width:',
        ...
        '<div class=\'feat-wrapitem\'></div>',
        '<div class="feat-wrapinner"></div>',
        '.feat-wrapitem:first-child',
        '.feat-wrapinner',
        '<div class=\'fbig-widget-area\'></div>',
        'gallery',
        ' hovergallery',
        'show botwid',
        '.hover-info',
        ...
        ' class="',
        'first-item ',
        'items"><div class="items-inner">',
        'class="rcptime">',
        'class="postdate absolute"><b>',
        '</small></div></div>',
        '<div class="table-cell thumb-outer',
        ' hoveffect',
        '"><div class="mythumb thumb-area',
        ' first-image',
        '"><div class="post-type absolute"><i class="fa fa-',
        '"></i></div><a class="rcthumb show" title="',
        '" href="',
        '" data-img="',
        '"',
        ...
        'class="',
        'first-area ',
        'content-area table-cell">',
        '"color:',
        'class="ct-before"><i class="fa fa-circle"></i></div>',
        '<p ',
        '"',
        'background-',
        'color:',
        'class="heading-text"><a ',
        'class="hoveffect"',
        ' href="',
        '</a></p><div class="metainfo">',
        '<div class="hide">',
        '</div> ',
        '<span class="wid-date"><i class="fa fa-calendar"></i> ',
        'DD',
        'MM',
        'YYYY',
        '<span class="widcomments"><i class="fa fa-comments-o"></i> <a href="',
        '"></a>',
        '<div class="psummary hide">',
        '<a class="readmorebut" href="',
        '#more" title="',
        '">More</a>',
        '<span class="rcptags absolute"><a ',
        'class="btn" title="',
        '</div></div>',
        'a[class="item-tag"]:lt(',
        '<h4><span class="title-wrap">',
        '</span></h4><div class="owl-nav"></div>',
        '/feeds/posts/summary?max-results=0&orderby=published&alt=json-in-script',
        '/feeds/posts/default?max-results=',
        '&orderby=published&start-index=',
        '&alt=json-in-script',
        '/feeds/comments/default?alt=json-in-script&orderby=published',
        '<div class="rcomment-area">',
        '<div class="rcomment-item',
        ' rcadmin',
        ' rcguest',
        '<amp-img class="rcomment-img" alt="',
        '" title="',
        '" href="',
        '" src="',
        '"/>',
        '<div class="rcomment-info"><a href="#',
        '</a><a class="rcomment-title" href=" ',
        '</a><div class="rcomment-meta"><div class="com-date"><b>',
        '</small></div></div><div class="com-time">',
        '</div></div></div>',
        '<div class="rcomment-summary">',
        '<div class="clear"></div></div>',
        ' <amp-img layout=\'responsive\' alt=\'emo\' src=\'',
        '\' class=\'emo\' alt=\'',
        '.rcomment-summary',
        '<span></span>',
        'Anonymous',
        '',
        'g',
        '<div class="shrt shrt-$1" $2 $3>',
        '.post-body,.cm_body p,.HTML .widget-content',
        'icon',
        '<i class="fa shrt-icon ',
        'fa-',
        'Tab',
        'Dont Have any text content',
        '.shrt-content',
        'shrt-tabhtml',
        '.shrt-tab,.shrt-vtab',
        '',
        ...
        '.shrt-accordion',
        'fast',
        '.acrd-content:visible',
        'h3.acrd-toggle',
        '.shrt-accordion .acrd-toggle',
        'src',
        'color',
        'featured',
        'height',
        ...
        'user',
        'playlist',
        '<div class="inlinestyle frame-shrt-soundcloud',
        ' pfeatured',
        '"><amp-iframe width="',
        '320',
        '" height="',
        '130',
        '" layout="responsive" resizable="resizable" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-top-navigation" scrolling="no" src="https://w.soundcloud.com/player/?url=https://api.soundcloud.com/',
        'tracks',
        'users',
        'xxxxxxx',
        '&amp;color=',
        ...
        '&amp;auto_play=',
        'false',
        '&amp;hide_related=false&amp;show_comments=',
        '&amp;show_user=',
        'true',
        '&amp;show_reposts=false&amp;visual=',
        '"><div overflow="true"/></amp-iframe></div>',
        '.shrt-soundcloud',
        'highlight',
        'background',
        'info',
        'logo',
        '<div class="inlinestyle frame-shrt-dailymotion',
        '"><amp-iframe width="',
        '270',
        '" layout="responsive" resizable="resizable" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-top-navigation" src="https://www.dailymotion.com/embed/video/',
        'x12k542',
        '?logo=',
        '1',
        '&info=',
        ...
        '370',
        '" layout="responsive" resizable="resizable" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-top-navigation" src="https://www.youtube.com/embed/',
        '9ua_4ajpP58',
        '?list=',
        '&amp;rel=',
        '&amp;controls=',
        ...
        '" allowfullscreen><div overflow="true"/></amp-iframe></div>',
        '.shrt-youtube',
        '<div class="inlinestyle frame-shrt-map',
        '" src="https://www.google.com/maps/embed?pb=',
        '"></amp-iframe></div>',
        '.shrt-map',
        'shrt-message',
        '.shrt-alert, .shrt-warning, .shrt-update, .shrt-success, .shrt-info, .shrt-error',
        '<div class="headline">',
        ...
        '<a class="shrtImgUrl ',
        ' rel="',
        '<amp-img layout="responsive" class="shrtImg',
        '" width="',
        '',
        '"/>',
        '.shrt-img',
        ...
        '#contact',
        '.shrt-contact',
        '" class="jdshrt-tooltip">',
        'Insert Link Title',
        'Insert Tooltip Text',
        '</span></a>',
        '.shrt-tooltip',
        '<div class="shrt-slide-item"><div class="shrt-inner"><a class="shrt-owl-img" "background: url(',
        ') no-repeat center center;background-size: cover;" href="',
        '"></a><div class="shrt-summary">',
        '<h3><a href="',
        '</a></h3>',
        '<p>',
        'shrt-inhtml',
        '.shrt-pslide',
        '<div class="shrt-carousel-item"><div class="shrt-inner"><a class="shrt-owl-img" "background: url(',
        '.shrt-pcarousel',
        'top',
        'review-value',
        '<div class="rev-item"><div class="rev-desc">',
        '',
        '</span></div><div class="rev-value-outer"><div class="rev-value" data-value="',
        '" "width:',
        '%"></div></div></div>',
        '<div class="rev-summary"><div class="rev-desc-place table-cell"><h4>',
        '',
        '</h4><span>',
        '',
        ...
        '',
        '</span></div></div></div>',
        '<div class="top-revscrore"><div class="c100"><div class="rev-score"></div><div class="slice"><div class="fill"></div><div class="bar"></div></div></div><span>',
        '</span></div>',
        '.rev-value',
        'data-value',
        '.rev-score',
        ...
        'data-url="',
        'data-color="',
        '<div class="aazs-widget" data-label="',
        '" data-type="',
        '>',
        '<div class="aazs-widget" data-label="random" data-type="simple rcpost">',
        '<div class="aazs-widget" data-label="random" data-type="simple rdpost">',
        '" data-type="simple ftpost">',
        '.aazs-widget',
        '.post-body strike',
        '.post-title',
        '.post-body h2 strike',
        ...
        '</locktag>',
        '<locktag>',
        '<div class="locked-content"><div class="inner"><i class="color fa fa-lock"></i><div class="locked-content-actions"><div class="locked-content-action"><div class="fb-like" data-href="',
        '" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div></div></div></div></div>',
        '',
        '.item-post .post-body',
        '',
        '',
        ...
        '.item-area',
        '.cm_form',
        '<a href="#origin_cform" onclick="Reset_Comment_Form()">',
        '#r_f_c',
        '#comment-editor',
        '&parentID=',
        '#%7B',
        ...
        '<a class="fa fa-',
        '.fa',
        '<div class=\'authoriconBox\'></div>',
        '.profile-sec .widget-content',
        '.item-topmeta .fn',
        ...
        'full-post',
        'hide-adstitle',
        '<div class="adsinside-it ads-outer"></div>',
        '.adsinside-it',
        '.adsbelow',
        '<div class="adstitle',
        '',
        '"><div class="adspltop"></div>',
        '',
        '.adspltop',
        '',
        '',
        ...
        '<div class="adsbottom',
        '',
        '<div class="adsplbottom"></div></div>',
        '.bottom-infoitem',
        '.adsplbottom',
        '',
        '<input type="hidden" class="aazs-page"></input><input type="hidden" class="aazs-per-page"></input>',
        '<div class="page-place no-decor"></div>',
        '[lnt]',
        '[fnt]',
        ...
        '.aazs-page',
        '.aazs-per-page',
        '<a class="previous_link btn"><i class="fa fa-chevron-left"></i></a>',
        '<a class="page_link btn" data-title="',
        '" ","href"," longdesc="',
        '<a class="next_link btn"><i class="fa fa-chevron-right"></i></a>',
        'active_page',
        '.page_link:first',
        'none',
        '.active_page',
        ...
        ':first',
        ':first .cm_reply',
        '<div class="cm_wrap" id="c',
        '" data-level="',
        ' .cm_child:first',
        '/s55-c/',
        '.cm-img',
        '<div class="nw_com"></div>',
        '.nw_com',
        '.comments-tabs .tab-wrapper div',
        '.comments-tabs .tab-wrapper',
        'table',
        'pfeatured',
        '.tr-caption',
        '<span class="pcaption absolute">',
        '.pfeatured',
        '.post-body img',
        '.post-featured',
        '<div class="slide-pfeatured"></div>',
        '.slide-pfeatured',
        '.glpost',
        '.separator',
        '.post-featured a',
        ...
        '.post-featured img',
        '/s600/',
        '<div class="hide url-post"><input aria-label="Post Url" class="url-post-input" type="text" value="" ',
        '" /></div>',
        '.url-post',
        '.showlink',
        'hover',
        ...
        '',
        '',
        '<a rel="noindex" class="menu-morepost',
        ' random',
        '" href="/search',
        '"></a>',
        'mcarousel',
        ...
        '.normal-tab',
        '<a rel="noindex" class="menu-morepost" href="/search/label/',
        'mtab',
        'mbig',
        'menulinks',
        '.links-submenu .widget',
        '.links-submenu',
        '<div class="links-content"><h2>',
        '</h2><div class="widget-content">',
        '.links-content',
        'gridpost',
        '<a rel="noindex" class="grid-h2" href="/search',
        '<a rel="noindex" class="morepost btn" href="/search',
        'li.submenu',
        '.menu-search',
        '.mobile-search',
        '.social-icon',
        ...
        '<a class="blog-pager-older-link-item go-right oldernewerright" title="Next Article - [title] - posted on [date]" href="[url]"><span>',
        '</span><div>[title]</div></a>',
        '<a class="blog-pager-newer-link-item go-left oldernewerleft" title="Previous Article - [title] - posted on [date]" href="[url]"><span>',
        '<amp-img layout="responsive" alt="blog-pager" src="',
        'a.blog-pager-older-link-item',
        'a.blog-pager-newer-link-item',
        'data-trans',
        '#body-area *',
        'span.trans',
        'scroll',
        ...
        'item-page-loaded',
        '.pager-isi',
        '/feeds/posts/default?alt=json-in-script&published-min=',
        '&max-results=0&callback=?',
        '/feeds/posts/default?alt=json-in-script&start-index=',
        '&max-results=3&callback=?',
        '/feeds/posts/default?alt=json-in-script&start-index=2&max-results=1&callback=?',
        '.populars-img',
        '.img-change',
        'background:url("',
        '") no-repeat center center;background-size: cover',
        ...
        '.item-tag',
        '.reco-place',
        '<div class="reco-place blog-posts"><h4>',
        '</h4><div class="reco-inner"></div><span class="btn reco-close"><svg height="28" viewBox="0 3 24 24" width="28"><path d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z" fill="#fff"></path></svg></span></div>',
        '.reco-inner',
        'showIt',
        'reco-click',
        '.reco-close',
        ...
        '.HTML > .widget-content',
        'small-post',
        '.tab-blogger #blogger_cm',
        '#blogger_cm',
        '.tab-blogger',
        '#Blog1',
        '#gPlusComment > div',
        '.main-wrapper',
        '.sidebar-right .innerwrap',
        '.sidebartabs',
        'min-height',
        '-webkit-transform',
        '-o-transform',
        ...
        'mouseup',
        '0s',
        '.mobile-menu .tab-wrapper a,.sub-button,.sub-button .fa',
        'ms',
        'translate(',
        'px,0)',
        '',
        ...
        _$_[308],
        _$_[309],
        /(tooltip|dailymotion|youtube|soundcloud|code|accordion|content|item|alert|success|warning|update|error|info|tab|vtab|pgallery|bgallery|amp-img|contact|2column|3column|4column|pslide|pcarousel|map|review)/
    ], sumLength = $(_$_[310]).length ? $(_$_[310]).attr(_$_[44]) : 200, fixM = !$(_$_[311]).length || _$_[235] != $(_$_[311]).attr(_$_[44]), mName = $(_$_[312]).length ? $(_$_[312]).attr(_$_[44]).split(_$_[217]) : _$_[313].split(_$_[76]), sSide = !$(_$_[314]).length || _$_[235] != $(_$_[314]).attr(_$_[44]), SSpeed = $(_$_[315]).length ? $(_$_[315]).attr(_$_[44]) : 5000, Npage = $(_$_[316]).length ? $(_$_[316]).attr(_$_[44]) : 10, fC = $(_$_[317]).length ? $(_$_[317]).attr(_$_[44]) : 2, dformat = $(_$_[318]).length && _$_[235] != $(_$_[318]).attr(_$_[44]) ? $(_$_[318]).attr(_$_[44]) : _$_[319], admBlog = !$(_$_[320]).length || _$_[321] != $(_$_[320]).attr(_$_[44]), hauthor = !$(_$_[322]).length || _$_[321] != $(_$_[322]).attr(_$_[44]), hLast = !(!$(_$_[323]).length || _$_[321] != $(_$_[323]).attr(_$_[44])), gCSE = !(!$(_$_[324]).length || _$_[235] == $(_$_[324]).attr(_$_[44])), cseID = $(_$_[324]).length && _$_[235] != $(_$_[324]).attr(_$_[44]) ? $(_$_[324]).attr(_$_[44]) : _$_[1], hlist = !(!$(_$_[326]).length || _$_[321] != $(_$_[326]).attr(_$_[44])), fpost = !$(_$_[327]).length || _$_[235] != $(_$_[327]).attr(_$_[44]), hpagenav = !$(_$_[328]).length || _$_[235] != $(_$_[328]).attr(_$_[44]), fbid = $(_$_[329]).length ? $(_$_[329]).attr(_$_[44]) : _$_[330], fblang = $(_$_[331]).length ? $(_$_[331]).attr(_$_[44]) : _$_[332], pajax = !$(_$_[333]).length || _$_[321] != $(_$_[333]).attr(_$_[44]), stx = $(_$_[334]).length && _$_[235] != $(_$_[334]).attr(_$_[44]) ? $(_$_[334]).attr(_$_[44]) : _$_[335], ntx = $(_$_[336]).length && _$_[235] != $(_$_[336]).attr(_$_[44]) ? $(_$_[336]).attr(_$_[44]) : _$_[337], ptx = $(_$_[338]).length && _$_[235] != $(_$_[338]).attr(_$_[44]) ? $(_$_[338]).attr(_$_[44]) : _$_[339], mtx = $(_$_[340]).length && _$_[235] != $(_$_[340]).attr(_$_[44]) ? $(_$_[340]).attr(_$_[44]) : _$_[341], lmtx = $(_$_[342]).length && _$_[235] != $(_$_[342]).attr(_$_[44]) ? $(_$_[342]).attr(_$_[44]) : _$_[343], vmtx = $(_$_[344]).length && _$_[235] != $(_$_[344]).attr(_$_[44]) ? $(_$_[344]).attr(_$_[44]) : _$_[345], reltx = $(_$_[346]).length && _$_[235] != $(_$_[346]).attr(_$_[44]) ? $(_$_[346]).attr(_$_[44]) : _$_[347], rectx = $(_$_[348]).length && _$_[235] != $(_$_[348]).attr(_$_[44]) ? $(_$_[348]).attr(_$_[44]) : _$_[349], recotx = $(_$_[350]).length && _$_[235] != $(_$_[350]).attr(_$_[44]) ? $(_$_[350]).attr(_$_[44]) : _$_[351], twau = $(_$_[352]).length && _$_[235] != $(_$_[352]).attr(_$_[44]) ? $(_$_[352]).attr(_$_[44]) : _$_[353], dsqsn = $(_$_[354]).length && _$_[235] != $(_$_[354]).attr(_$_[44]) ? $(_$_[354]).attr(_$_[44]) : _$_[1], dO = $(_$_[355]).length && _$_[235] != $(_$_[355]).attr(_$_[44]) ? $(_$_[355]).attr(_$_[44]) : _$_[1], shrel = !$(_$_[356]).length || _$_[235] != $(_$_[356]).attr(_$_[44]), shreco = !(!$(_$_[357]).length || _$_[321] != $(_$_[357]).attr(_$_[44])), relst = $(_$_[358]).length ? $(_$_[358]).attr(_$_[44]) : _$_[359], hecpt = !(!$(_$_[360]).length || _$_[321] != $(_$_[360]).attr(_$_[44])), hrev = !(!$(_$_[361]).length || _$_[321] != $(_$_[361]).attr(_$_[44])), tbline = !(!$(_$_[362]).length || _$_[321] != $(_$_[362]).attr(_$_[44])), bbline = !(!$(_$_[363]).length || _$_[321] != $(_$_[363]).attr(_$_[44])), aplay = !(!$(_$_[364]).length || _$_[321] != $(_$_[364]).attr(_$_[44])), blinest = $(_$_[365]).length ? $(_$_[365]).attr(_$_[44]) : _$_[220], btlinest = $(_$_[366]).length ? $(_$_[366]).attr(_$_[44]) : _$_[220], dajaxsrc = !(!$(_$_[367]).length || _$_[321] != $(_$_[367]).attr(_$_[44])), mx = {
...
var csystext = $(_$_[417]).text(), cnurl = $(_$_[418]).attr(_$_[44]), bpstid = $(_$_[419]).attr(_$_[44]), psturl = $(_$_[420]).attr(_$_[44]), bcom = _$_[421], dcom = _$_[422], fcom = _$_[423] + cnurl + _$_[424], scom = _$_[425] + bpstid + _$_[424];
if ($(_$_[417]).html(csystext.replace(/\[googlep\]/g, bcom).replace(/\[disqus\]/g, dcom).replace(/\[facebook\]/g, fcom)), $(_$_[427]).each(function () {
    ...
    var slide_nav = $(_$_[443]), current_pos = 0, current_menu_width = 0;
...
var sfArr = function (_) {
        ...
        if (0 === a)
            return !1;
        for (; --a;)
            t = Math.floor(Math.random() * (a + 1)), e = _[a], _[a] = _[t], _[t] = e;
        return _;
    }, gRdm = function (_, t) {
...
gCSE || dajaxsrc || ajaxsrc(), $(_$_[504]).find(_$_[503]).each(function () {
...
}), $(_$_[504]).myTab({ active: 1 }), $(_$_[506]).click(function () {
    var _ = $(this);
    return _.hasClass(_$_[18]) ? ($(_$_[505]).fadeOut(), _.removeClass(_$_[18])) : (_.addClass(_$_[18]), $(_$_[505]).fadeIn()), !1;
}), cdate(), function (_) {
    if (_(_$_[509]).hasClass(_$_[508]) && !hpagenav)
        hlist ? (lMore({ viewdefault: _$_[139] }), vmode({ viewdefault: _$_[139] })) : (lMore(), vmode());
    ...
    A.RCWid = function (_, e) {
        ...
        j.$el = A(_), j.init = function () {
            ...
            var f, v, x, b, w, y, C, k = 0, t = null, T = location.href.replace(rgx[17], _$_[1]), S = document.location.hostname.split(_$_[428]), L = j.options.maxPostsPerTag, P = 3, I = 1, N = _$_[1] === j.options.blogURL ? window.location.protocol + _$_[95] + window.location.host : j.options.blogURL, O = function (_) {
                    for (j.options.ShowPage && function (_) {
                            for (html = _$_[1], number = parseInt(P / 2), number == P - number && (P = 2 * number + 1), start = I - number, start < 1 && (start = 1), maximal = parseInt(_ / L) + 1, maximal - 1 == _ / L && --maximal, akhir = start + P - 1, akhir > maximal && (akhir = maximal), _ = parseInt(I) - 1, 1 < I && (html = 2 == I ? html + _$_[525] : html + (_$_[526] + _ + _$_[527])), 1 < start && (html += _$_[528]), 2 < start && (html += _$_[529]), _ = start; _ <= akhir; _++)
                                html = I == _ ? html + (_$_[530] + (_$_[1] === j.options.color ? _$_[1] : _$_[519] + j.options.color + _$_[531] + j.options.color + _$_[532]) + _$_[533] + _ + _$_[105]) : 1 == _ ? html + _$_[528] : html + (_$_[526] + _ + _$_[22] + _ + _$_[77]);
                            akhir < maximal - 1 && (html += _$_[529]), akhir < maximal && (html += _$_[526] + maximal + _$_[22] + maximal + _$_[77]), _ = parseInt(I) + 1, I < maximal && (html += _$_[526] + _ + _$_[534]), j.$el.find(_$_[535]).html(html), j.$el.find(_$_[543]).click(function () {
                                ...
                                var t = _ * L - (L - 1), e = j.$el.find(_$_[535]).attr(_$_[539]);
                    ...
                    if (entry = !0 === j.options.random ? sfArr(_.feed.entry) : _.feed.entry, void 0 !== entry)
                        for (var t = entry.length, e = 0; e < t; e++) {
                            ...
                            if (m = _$_[236] === j.options.postType && f !== window.location.protocol + _$_[95] + window.location.host + _$_[55] ? f.substr(f.lastIndexOf(_$_[55]) + 1) : void 0 !== entry[e].category ? entry[e].category[0].term : _$_[1], h = j.options.fbig && entry[e] === entry[0], p = entry[e] !== entry[0], c = _$_[108] in entry[e] ? entry[e].content.$t : _$_[109] in entry[e] ? entry[e].summary.$t : _$_[1], _$_[110] in entry[e] ? ($ = entry[e].media$thumbnail.url, -1 != entry[e].media$thumbnail.url.indexOf(_$_[58]) && ($ = entry[e].media$thumbnail.url.replace(_$_[113], _$_[114]), u = _$_[54])) : rgx[6].test(c) || rgx[8].test(c) ? ($ = rgx[6].exec(rgx[6]), s = rgx[8].exec(c), $ = _$_[53] + (null != $ ? $[5] : s[3]) + _$_[52], u = _$_[54]) : $ = rgx[5].test(c) ? (s = rgx[5].exec(c))[4] : _$_[56], rgx[9].test(c) ? u = _$_[54] : rgx[10].test(c) ? u = _$_[62] : rgx[11].test(c) ? u = _$_[63] : rgx[12].test(c) && (u = rgx[12].exec(c).index <= 5 ? _$_[64] : _$_[39]), rgx[29].test(c) && j.options.review) {
                                for (g = [], s = 0, n = (g = c.match(rgx[29])).length, o = 0; o < n; o++)
                                    s += parseInt(g[o].replace(rgx[29], _$_[66]).replace(/"/g, _$_[1]).replace(/'/g, _$_[1]));
                    ...
                    if (k >= j.options.tags.length) {
                        if (0 < j.options.maxPosts && A(_$_[553] + (j.options.maxPosts - 1) + _$_[554], j.$el.find(_$_[555])).remove(), j.$el.find(_$_[537]).html(j.$el.find(_$_[555]).html()).removeClass(_$_[556]), j.$el.find(_$_[557]).remove(), e = j.$el.find(_$_[558]), a = j.$el.parents(_$_[518]).attr(_$_[25]), i = A(_$_[45]).attr(_$_[44]), e.attr(_$_[44], i + _$_[76] + e.attr(_$_[44])).text(i), /(newsticker|timeline|video|gallery|featured|hot|slider)/.test(a) && j.$el.addClass(_$_[559]), /(video|featured|hot|slider)/.test(a) && j.$el.addClass(_$_[560]), a = j.$el.find(_$_[537]), _$_[233] === j.options.postType)
                        ...
                        else if (_$_[234] === j.options.postType)
                            a.owlCarousel({
                                autoplay: j.options.auto,
                                margin: 0,
                                loop: !0,
                        ...
                        else if (_$_[235] === j.options.postType)
                            a.simplyScroll();
                        else if (_$_[236] === j.options.postType) {
                            for (i = a.children(_$_[565]), e = 0; e < i.length; e += j.options.wrapNum)
                                i.slice(e, e + j.options.wrapNum).wrapAll(_$_[566]);
                            a.owlCarousel({
                                nav: !0,
                                autoplay: j.options.auto,
                                navText: [
                            ...
                            for (i = a.children(_$_[565]), e = 0; e < i.length; e += j.options.wrapNum)
                                i.slice(e, e + j.options.wrapNum).wrapAll(_$_[567]);
                        ...
                        if (j.options.fbig)
                            for (i = a.children(_$_[565]), e = 0; e < i.length; e += i.length)
                                i.slice(1, e + i.length).wrapAll(_$_[571]);
                        if (j.options.hoverEffect && j.$el.find(_$_[576]).hover(function () {
                                var _, t = A(this), e = t.parents(_$_[565]).html(), a = t.height(), s = t.offset(), $ = A(document.body).width(), i = A(this).parents(_$_[503]).hasClass(_$_[572]) ? _$_[573] : _$_[1];
                            ...
                            if (j.options.startFirst) {
                                for (i = a.find(_$_[584]), e = 0; e < i.length; e += i.length)
                                    i.slice(e, e + i.length).wrapAll(_$_[585]);
                                ...
                                for (i = a.children(_$_[565]), e = 0; e < i.length; e += i.length + 1)
                                    i.slice(e, e + i.length + 1).wrapAll(_$_[585]);
                                (e = j.$el.find(_$_[586])).wrap(_$_[587]), e.simpleSpy({ limit: 5 }).on(_$_[590], function () {
                                    jQuery(this).trigger(_$_[591]);
                                }).on(_$_[588], function () {
                                    jQuery(this).trigger(_$_[589]);
                                });
                            }
                        chside(j.$el), _$_[1] !== j.options.color && j.$el.parents(_$_[518]).find(_$_[592]).length && j.$el.parents(_$_[518]).find(_$_[564]).children().css({ 'background-color': j.options.color });
                    }
                }, M = function (_, t, e, a, s, $, i, r, n, o, l, d, c, h, p, m) {
                    for (var u = A(_$_[565], j.$el.find(_$_[555])), g = 0, f = u.length; g < f; g++) {
                        var v = A(_$_[28], u.eq(g)), x = R(v);
                        if (v.attr(_$_[27]) == _) {
                            for (t = ++x, (_ = v).attr(_$_[593], t), j.options.relevantTip && _.attr(_$_[44], j.options.relevantTip.replace(_$_[594], t)), j.options.postScoreClass && _.attr(_$_[25], j.options.postScoreClass + t), _ = g - 1; 0 <= _; _--)
                                if (t = A(_$_[28], u.eq(_)), R(t) > x)
                                    return void (1 < g - _ && u.eq(_).after(u.eq(g)));
            ...
            !function () {
                ...
                if (j.options.tags || (j.options.tags = [], A(_$_[643] + j.options.maxTags + _$_[554]).each(function () {
                        ...
                        -1 == A.inArray(_, j.options.tags) && (j.options.tags[j.options.tags.length] = _);
                    }), _.length || (j.options.tags = [])), 0 !== j.options.tags.length || j.options.recentTitle)
                    if (_.length && A(_$_[644] + (0 === j.options.tags.length ? j.options.recentTitle : j.options.relatedTitle ? j.options.relatedTitle : _$_[1]) + _$_[645]).prependTo(t), 0 === j.options.tags.length)
                        j.options.random ? A.get(N + _$_[646], function (_) {
                        ...
                        for (_ = 0; _ < j.options.tags.length; _++)
                            A.get(N + _$_[542] + j.options.tags[_] + _$_[222] + j.options.maxPostsPerTag + _$_[541], O, _$_[130]), j.options.ShowPage && j.$el.find(_$_[535]).attr(_$_[539], j.options.tags[0]);
            }();
        }, j.init();
            ...
            f.options = v.extend({}, v.RCom.defaultOptions, t), v.get((_$_[1] === f.options.blogURL ? window.location.protocol + _$_[95] + window.location.host : f.options.blogURL) + _$_[650], function (_) {
                ...
                if (n.entry && 0 !== n.entry.length) {
                    ...
                    for (var s, $, i, r, n, o = 0, l = 0, d = (n = n.entry).length; l < d; ++l) {
                        ...
                        var c = s.author[0].name ? s.author[0].name.$t : f.options.anon, h = !!s.author[0].uri && s.author[0].uri.$t, p = s.author[0].gd$image.src.replace(rgx[7], _$_[111] + f.options.avatarSize + _$_[112]), m = (m = s.content ? s.content.$t : s.summary.$t).replace(/<br *\/?>|[\s]+/gi, _$_[76]).replace(/<.*?>|[<>]/g, _$_[1]).replace(rgx[16], _$_[1]), u = (m = _$_[1] !== m && m.length > f.options.characters ? m.substring(0, f.options.characters) + _$_[115] : m, !1), g = c === _ || p === a;
                        if (!g || f.options.showAdmin) {
                            for ($ = 0, r = s.link.length; $ < r; ++$)
                                e = s.link[$], _$_[106] == e.rel && (u = e.href);
    ...
    var _ = rgx[34], t = new RegExp(/\[/.source + _.source + /(.*?)(\/?)\]/.source, _$_[673]), e = (_ = new RegExp(/\[\//.source + _.source + /\]/.source, _$_[673]), $(this).html());
    t.test(e) && (e = e.replace(t, _$_[674]).replace(_, _$_[94]), $(this).html(e));
}), $(_$_[683]).each(function () {
    $(this).find(_$_[681]).each(function () {
        var _ = $(this).attr(_$_[44]), t = $(this).attr(_$_[676]), e = _$_[677] + (null == t || _$_[1] == t ? _$_[1] : _$_[678] + t) + _$_[26], a = $(this).html();
    ...
    var _ = $(this), t = _.attr(_$_[302]), e = _.attr(_$_[699]), a = _.attr(_$_[700]), s = _.attr(_$_[70]), i = _.attr(_$_[701]), r = _.attr(_$_[702]), n = _.attr(_$_[703]), o = _.attr(_$_[704]), l = _.attr(_$_[705]), d = _.attr(_$_[706]);
    ...
    var _ = $(this), t = _.attr(_$_[727]), e = _.attr(_$_[728]), a = _.attr(_$_[700]), s = _.attr(_$_[699]), i = _.attr(_$_[70]), r = _.attr(_$_[701]), n = _.attr(_$_[702]), o = _.attr(_$_[729]), l = _.attr(_$_[730]);
    ...
    var _ = $(this), t = _.attr(_$_[699]), e = _.attr(_$_[70]), a = _.attr(_$_[702]), s = _.attr(_$_[729]), i = _.attr(_$_[701]), r = _.attr(_$_[747]), n = _.attr(_$_[706]), o = _.attr(_$_[748]);
    ...
    var _ = $(this), t = _.attr(_$_[699]), e = _.attr(_$_[70]), a = _.attr(_$_[701]), s = _.attr(_$_[702]);
    ...
    var _ = $(this), t = _.attr(_$_[699]), e = _.attr(_$_[768]), a = _.attr(_$_[769]), s = _.attr(_$_[701]), i = _$_[770] + e + _$_[771], r = _.attr(_$_[70]), n = _.attr(_$_[702]);
    ...
    var _ = $(this).attr(_$_[782]), t = $(this).html();
...
$(_$_[794]).each(function () {
    ...
    var _ = $(this).attr(_$_[768]), t = $(this).attr(_$_[44]), e = $(this).html();
    ...
    var s = _$_[1];
    $(this).find(_$_[689]).each(function () {
        var _ = $(this).attr(_$_[44]), t = $(this).attr(_$_[768]), e = $(this).attr(_$_[699]), a = $(this).html();
    ...
    var t = _.find(_$_[826]), e = t.length, a = 0;
    t.each(function () {
    ...
    var _, t, e, a = $(this), s = a.children(_$_[835]), i = s.text(), r = rgx[33] + _$_[94];
...
if ($(_$_[518]).each(function () {
        var _ = $(this), t = _.children(_$_[835]), e = _.find(_$_[844]), a = t.text(), s = 0.1 * _.height() - winHe + _.offset().top, i = $(document).scrollTop();
        ...
        var a = [], s = $(this).html(), i = $(_$_[851]).attr(_$_[850]), _ = $(_$_[852]).attr(_$_[108]), t = /\[lock\]/g, e = /\[\/lock\]/g;
    ...
    0 < $(_$_[874]).length && $(_$_[512]).hasClass(_$_[156]) && ($(_$_[879]).each(function () {
        ...
        for (var t = 0; t < _.length; t += _.length + 1)
            _.slice(t, t + _.length + 1).wrapAll(_$_[878]);
    }), $(_$_[874]).each(function () {
        var _ = /(\r\n|\n|\r)/gm, t = $(_$_[880]).length ? $(_$_[880]).text().replace(_, _$_[1]) : _$_[881], e = (_ = (e = $(this)).children(_$_[216]).html().replace(_, _$_[1]), e.find(_$_[882]).html());
    ...
    var $postbody = $(_$_[402]).html(), $adsisi = $(_$_[890]), myrgx = /\[(full-post|left-post|right-post|left-side|right-side|hideadstitle)\]/g;
    ...
    if ($(_$_[910]).length && !/\[hidebottomads\]/.test($postbody) && ($(_$_[914]).before(_$_[911] + (bbline ? _$_[902] : _$_[1]) + _$_[22] + (bbline ? _$_[912] : _$_[1]) + _$_[913]), $(_$_[915]).html($(_$_[910]).detach()), $(_$_[916]).length && $(_$_[916]).RCWid({
        ...
        var show_per_page = 1, $this = $(_$_[851]);
        ...
        for (var navigation_html = _$_[926], current_link = 0; number_of_pages > current_link;)
            navigation_html += _$_[927] + current_link + _$_[928] + current_link + _$_[22] + (current_link + 1) + _$_[77], current_link++;
        ...
        var go_to_page = function (_) {
            ...
            start_from = _ * t, end_on = start_from + t, contentnya.children().css(_$_[180], _$_[932]).slice(start_from, end_on).css(_$_[180], _$_[181]), $this.find(_$_[934] + _ + _$_[935]).addClass(_$_[930]).siblings(_$_[933]).removeClass(_$_[930]), curpagenya.val(_), $(_$_[205]).animate({ scrollTop: $(_$_[402]).offset().top - 80 }, 1000);
        };
        $this.find(_$_[937]).on(_$_[9], function () {
            ...
            return $(this).attr(_$_[939]), contentnya.children().css(_$_[180], _$_[181]), pageplace.hide(), $(_$_[205]).animate({ scrollTop: $(_$_[402]).offset().top - 80 }, 1000), !1;
        });
    }
    $(_$_[954]).each(function () {
        ...
        var _ = $(this), t = _.attr(_$_[44]), e = _.parent(_$_[28]), a = _.parents(_$_[959]);
    ...
    var txtnyaaa = $(_$_[402]).html(), imgjd = [], pfeat = (imgjd = /<amp-img\s+[^>]*src="([^"]*)"[^>]*>/.exec(txtnyaaa), $(_$_[963]));
    if (pfeat.length)
        $(_$_[963]).each(function () {
            $(_$_[965]).append($(this));
        ...
        var img = $(_$_[964]).first(), par = img.parent(_$_[28]), pars = img.parents(_$_[959]), gpars = img.parents(_$_[968]), pars2 = img.parents(_$_[969]);
        if (!gpars.length) {
...
var $outer = $(_$_[981]), $contact = $(_$_[982]);
$(_$_[984]).click(function () {
    ...
    var _ = $(this), e = _.find(_$_[35]), t = e.text();
    if (/grid/g.test(t))
        t = t.replace(/grid\//g, _$_[1]), _.addClass(_$_[581]), e.RCWid({
            maxPosts: 4,
            random: _$_[238] === t,
            review: !hrev,
        ...
        for (var s = 0; s < a.length; s++)
            t += _$_[256] + a[s] + _$_[22] + a[s] + _$_[94];
        ...
        /mbig/g.test(t) ? (t = t.replace(/mbig\//g, _$_[1]), _.addClass(_$_[581]), e.RCWid({
            maxPosts: 7,
            random: _$_[238] === t,
            ...
            review: !hrev,
            summary: 100
        }), e.append(_$_[990] + (_$_[238] === t ? _$_[991] : _$_[1]) + _$_[992] + (_$_[220] === t ? _$_[1] : _$_[221] + t) + _$_[222] + Npage + _$_[993]).addClass(_$_[999])) : /links/g.test(t) && (_.addClass(_$_[581]), e.html(_$_[1]), e.addClass(_$_[1000]), _ = $(_$_[1001]), $(_$_[1002]).hide(), _.each(function () {
            var _ = $(this).children(_$_[216]).html(), t = $(this).children(_$_[835]).html();
            e.append(_$_[1003] + _ + _$_[1004] + t + _$_[642]);
        }), e.find(_$_[835]).each(function () {
            if (texnya = $(this).text(), /gridpost/g.test(texnya)) {
                var _ = $(this).parents(_$_[987]), t = texnya.replace(/gridpost\//g, _$_[1]).replace(/(\r\n|\n|\r)/gm, _$_[1]);
                $(this).RCWid({
                    maxPosts: 4,
                    random: _$_[238] === t,
                    ShowTags: !!/(recent|random)/.test(t),
...
}), $(_$_[987]).css({ 'max-height': $(window).height() - 140 });
var maxSummaryLength = sumLength, olderLink = _$_[1016] + ptx + _$_[1017], newerLink = _$_[1018] + ntx + _$_[1017], defaultImage = _$_[776], getThumb = function (_, t) {
        var e, a = t;
        e = _.content.$t;
        try {
        ...
        var i = $(_).attr(_$_[27]);
        if ((n = (n = _$_[108] in a ? a.content.$t : _$_[109] in a ? a.summary.$t : _$_[1]).replace(rgx[15], _$_[1]).replace(rgx[16], _$_[1]).replace(/"/g, _$_[73])).length > maxSummaryLength)
            var r = (n = n.substring(0, maxSummaryLength)).lastIndexOf(_$_[76]), n = n.substring(0, r) + _$_[115];
...
$(_$_[1024]).each(function () {
    var _ = $(this).attr(_$_[44]), t = $(this).attr(_$_[1022]);
...
$(window).on(_$_[1025], function () {
    ...
    if ($(_$_[1035]).length < d) {
        ...
        $(_$_[518]).each(function () {
            if (!$(this).hasClass(_$_[275])) {
                var _ = $(this), t = _.children(_$_[835]), e = _.find(_$_[844]), a = t.text();
                c && ldwid(e, _, t, a);
            }
        });
    }
    ...
    location.pathname.replace(/^\//, _$_[1]) == this.pathname.replace(/^\//, _$_[1]) && location.hostname == this.hostname && (target = (target = $(this.hash)).length ? target : $(_$_[1080] + this.hash.slice(1) + _$_[935])).length && (_$_[1081] == typeof document.body.style.transitionProperty ? (_.preventDefault(), (_ = $(document).height() - $(window).height()) < (scroll = target.offset().top) && (scroll = _), $(_$_[153]).css({
        ...
        transition: _$_[1083]
    }).data(_$_[1082], !0)) : $(_$_[205]).animate({ scrollTop: scroll }, 1000));
    ...
    }), (r = (t = $(_$_[154])).width()) < 680 ? t.addClass(_$_[1089]) : t.removeClass(_$_[1089]), $(_$_[1090]).length || $(_$_[1092]).append($(_$_[1091])), $(_$_[1093]).length && (r = $(_$_[1094]).width(), $(_$_[1095]).css({ width: r }));
    var _ = $(window).width(), t = $(_$_[1096]).height(), e = $(_$_[1097]).height(), a = $(_$_[207]).height(), s = $(_$_[1098]).height(), i = $(_$_[209]).height(), r = $(_$_[1033]).width();
...
var Bamboo = function (t, _) {
    ...
    $(_$_[1106]);
    var a, s, r = $(_$_[981]), n = r.parent().children(_$_[1107]), o = (s = !1, _$_[1108] in t || t.DocumentTouch && _ instanceof DocumentTouch ? (s = !0, $(_$_[153]).addClass(_$_[1109])) : $(_$_[153]).addClass(_$_[16]), s), l = (a = 0, navigator.userAgent.match(/(iPhone|iPod)/i) && -1 != navigator.userAgent.indexOf(_$_[1110]) && -1 == navigator.userAgent.indexOf(_$_[1111]) && (a = 60), _$_[1112] in t.navigator && t.navigator.standalone && (a = 0), a), c = _$_[1114] in t ? _$_[1115] : _$_[1086], p = o ? _$_[1120] : _$_[1121];
    return e.prototype = {
        info: {},
        x: 0,
        dx: 0,
        ...
        resizeSite: function () {
            this.info.docHeight = $(t).height(), this.info.docWidth = $(t).width(), this.layout(), this.snapThreshold = null === this.options.snapThreshold ? Math.round(0.25 * this.info.docWidth) : /%/.test(this.options.snapThreshold) ? Math.round(this.info.docWidth * this.options.snapThreshold.replace(_$_[71], _$_[1]) / 100) : this.options.snapThreshold, this.options.resize && this.options.resize();
        },
        layout: function () {
        ...
        _moveContainer: function (_) {
            n.css({ transform: _$_[1125] + _ + _$_[1126] + d });
        },
